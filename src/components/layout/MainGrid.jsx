...
export default function MainGrid({ children }) {
  ...
  return (
    <>
      <div className="grid grid-cols-1 items-start gap-4 md:landscape:grid-cols-[minmax(0,1fr)_220px] lg:landscape:grid-cols-[minmax(0,1fr)_260px] xl:grid-cols-[minmax(0,1fr)_295px] xl:gap-6">
        ...
        <aside className="hidden w-full min-w-0 py-6 pl-0 pr-0 md:landscape:block lg:pl-1 lg:pr-1 md:landscape:sticky md:landscape:bottom-6 md:landscape:self-end xl:block xl:sticky xl:bottom-6 xl:self-end">
